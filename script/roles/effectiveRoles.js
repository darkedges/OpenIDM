...
java.lang.System.out.println(object.employeeType);
if (object.employeeType === 'trial') {
	java.lang.System.out.println("Adding role openam");
     effectiveRoles = effectiveRoles.concat(['managed/role/openam']);
 }
